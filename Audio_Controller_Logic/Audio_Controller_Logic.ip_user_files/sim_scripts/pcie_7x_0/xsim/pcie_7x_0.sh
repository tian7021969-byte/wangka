...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -d "SIMULATION="  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pcie_7x_0 xil_defaultlib.pcie_7x_0 xil_defaultlib.glbl -log elaborate.log
}
