...
HD_PWD='C:/Users/dukehhu/Desktop/amd/Audio_Controller_Logic/Audio_Controller_Logic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hda_pcie_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hda_pcie_top.tcl -notrace
